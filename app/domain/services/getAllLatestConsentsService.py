...
async def get_all_latest_consents(mdm_id: str, db: AsyncSession):
    """
    Service to get all latest consents for a given mdm_id

    Not limited to a specific consent name
    """
